...
This standalone preflight writes `<scan-id>-timestamp.md` and `<scan-id>-timestamp.json` artifacts. The `security-review-*.md` naming is used by the full hosted skill flow.
