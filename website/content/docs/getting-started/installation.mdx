...
|   |-- account-abstraction/     # Account validate/execute/session-key guidance
|   |-- cairo-contract-authoring/ # Cairo contract authoring workflow
|   |-- cairo-testing/           # snforge testing patterns
|   |-- cairo-auditor/           # Cairo audit orchestration and findings gating
|   |-- cairo-optimization/      # Profiling + BoundedInt optimization rules
|   |-- cairo-deploy/            # Deployment with sncast
|   +-- starknet-network-facts/  # Protocol constraints that affect safety
|
